...
@section('content')
    ...
    <div class="content-header px-4 pt-4">
        <div class="container-fluid">
            <h1 class="page-title text-start"><i class="fas fa-user-plus me-2"></i> Create New Customer</h1>
        </div>
    </div>
                ...
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4 text-start">
                            ...
                            <select name="type_of_business" id="search_business" class="form-select select2 shadow-none">
                                <option value="">Search Business Type...</option>
                                @foreach ($type_of_business as $bt)
                                    <option value="{{ $bt->id }}"
                                        {{ old('type_of_business') == $bt->id ? 'selected' : '' }}>{{ $bt->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="mt-4 text-start border-top pt-4">
                        <button type="submit" class="btn-submit-custom">Create Customer Account</button>
