                            ...
                            @foreach ($permissions as $permission)
                                <tr>
                                    <td class="permission-name">
                                        <i class="fas fa-lock-open me-2 opacity-50 text-primary"
                                            style="font-size: 12px;"></i>
                                        {{ $permission->name }}
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('permissions.edit', $permission->id) }}" class="btn-action-sm"
                                            ...
                                            <form action="{{ route('permissions.destroy', $permission->id) }}"
                                                ...
                                                <button type="submit" class="btn-action-sm"
                                                    ...
                                                    onclick="confirmDelete(event, 'This permission will be deleted!')">
