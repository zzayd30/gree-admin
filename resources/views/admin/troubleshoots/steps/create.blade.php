...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6 text-start">
                    <h1 class="page-title"><i class="fas fa-plus-circle me-2"></i> Add Troubleshoot Step</h1>
                    <p class="text-muted small mb-0 mt-1">Add a new step to: <strong>{{ $troubleshoot->name }}</strong></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="form-card">
                <form action="{{ route('troubleshoots.steps.store', $troubleshoot->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-4 text-start">
                            ...
                            <input type="number"
                                ...
                                name="step_number"
                                value="{{ old('step_number', $troubleshoot->steps()->max('step_number') + 1) }}"
                                min="1" placeholder="Enter step number" required>
                            @error('step_number')
                        ...
                        <div class="col-md-6 mb-4 text-start">
                            ...
                            <input type="text"
                                ...
                                name="sensor_type" value="{{ old('sensor_type') }}"
                        ...
                        <div class="col-md-12 mb-4 text-start">
                            ...
                            <textarea class="form-control custom-input @error('action') is-invalid @enderror" name="action" rows="3"
                                placeholder="Describe the action to be taken" required>{{ old('action') }}</textarea>
                            @error('action')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
