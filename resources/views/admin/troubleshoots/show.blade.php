    ...
    <div class="content-header px-4 pt-4 text-start">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-8">
                    <h1 class="page-title"><i class="fas fa-microchip me-3"></i>ERROR CODE:
                        {{ strtoupper($troubleshoot->name) }}</h1>
                ...
                <div class="col-lg-7 mb-4">
                    <div class="modern-card">
                        ...
                        <div class="info-group">
                            ...
                            <div class="info-val">
                                <span
                                    class="status-badge {{ $troubleshoot->status == 'active' ? 'bg-active' : 'bg-inactive' }}">
                                    {{ $troubleshoot->status }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="modern-card">
                        ...
                        <div class="p-4">
                            ...
                            <div class="validation-box">
                                ...
                                <p class="text-muted small mb-0">This error code has been verified and is ready for field
                                    deployment.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modern-card mt-2">
                            ...
                            <tbody>
                                @foreach ($troubleshoot->steps as $step)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-light text-primary border px-3">STEP
                                                {{ $step->step_number }}</span></td>
                                        <td class="fw-bold">{{ $step->action }}</td>
                                        <td><span class="badge bg-info"
                                                style="background-color: #e0f2fe !important; color: #0369a1 !important;">{{ $step->sensor_type }}</span>
                                        </td>
                ...
                @else
                    <div class="p-5 text-center">
                        ...
                        <a href="{{ route('troubleshoots.steps.create', $troubleshoot->id) }}"
                            class="btn btn-primary btn-sm px-4 mt-2">CREATE FIRST STEP</a>
                    </div>
                @endif
            </div>
        </div>
