...
<style>
    ...
    .form-label { font-weight: 700; color: #243a7f; text-transform: uppercase; font-size: 11px; letter-spacing: 0.5px; margin-bottom: 8px; display: block; }
    ...
    .avatar-preview-box {
        ...
        background-color: #f1f5f9; border: 4px solid #fff;
    ...
    .btn-update-password {
        ...
        font-weight: 700 !important; border: none !important;
        width: 100% !important; box-shadow: 0 4px 10px rgba(255, 193, 7, 0.2) !important;
    }
    ...
    .select2-container--default .select2-selection--single .select2-selection__rendered { line-height: 45px !important; padding-left: 15px !important; }
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4 text-start">
                                ...
                                <select name="type_of_business" id="profile_biz_select" class="form-select select2" required>
                        ...
                        <div class="mb-4 text-start">
                            ...
                            <input type="file" name="profile_picture" class="form-control custom-input" accept="image/*">
